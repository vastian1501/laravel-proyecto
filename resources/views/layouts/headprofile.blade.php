        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="flex gap-2 items-center">
                <a class="flex items-center gap-2 bg-white border p-2 text-gra-600 rounded text-sm
                        uppercase font-medium cursor-pointer" href="{{ route('posts.create') }}">
                ...
                <div class="mx-2 relative">
                    <div x-data="{ dropdownOpen: false }" class="relative ">
                        <button @click="dropdownOpen = !dropdownOpen" class="relative z-10 block rounded-md bg-white p-2 focus:outline-none">
                            ...
                            <img class="h-10 w-10 rounded-full border border-gray-300" src="{{ auth()->user()->imagen ? asset('perfiles').'/'.auth()->user()->imagen : asset('img/usuario.svg')}}" alt="">
