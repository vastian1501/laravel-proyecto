...
<body class="bg-gray-100 min-h-screen flex flex-col">
                ...
                <div class="mx-2 relative">
                    <div x-data="{ dropdownOpen: false }" class="relative ">
                        <button @click="dropdownOpen = !dropdownOpen" class="relative z-10 block rounded-md bg-white p-2 focus:outline-none">
                            ...
                            <img class="h-10 w-10 rounded-full border border-gray-300 hover:border-lime-400" src="{{ auth()->user()->imagen ? asset('perfiles').'/'.auth()->user()->imagen : asset('img/usuario.svg')}}" alt="">
    ...
    <main class="container mx-auto mt-10 flex-grow">
        <h2 class="font-semibold text-center text-3xl mb-10 text-lime-500">
            @yield('cabecera')
        </h2>
        @yield('contenido')
    </main>
